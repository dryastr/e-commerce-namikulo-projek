    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @if (auth()->user()->role->name == 'admin')
                ...
                <li class="sidebar-item has-sub {{ Request::is('catalog_products*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-card-checklist"></i>
                        <span>Produk</span>
                    </a>
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ Request::routeIs('catalog_products.index') ? 'active' : '' }}">
                            <a href="{{ route('catalog_products.index') }}" class="submenu-link">Daftar Produk</a>
                        </li>
                    </ul>
                </li>
            @endif
